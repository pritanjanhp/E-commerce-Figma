...
const Featured = () => {
  return (
    <div className="lg:w-[1170px] w-full lg:h-[768px] h-full top-[4253px] left-[135px] gap-11 px-4 sm:px-8 md:px-12">
      <div className="flex md:flex flex-row lg:w-[216px] lg:h-[108px] w-full h-full gap-[20px] lg:px-3">
      ...
      <div className="flex flex-wrap w-full lg:w-[1170px] h-full lg:h-[600px] gap-[30px] justify-between ">
        ...
        <div className="w-full sm:w-[570px] h-[600px] left-0 relative bg-black lg:px-3">
          <Image
